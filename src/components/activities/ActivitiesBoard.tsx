  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[480px_1fr] gap-4 h-[calc(100vh-420px)] min-h-0 overflow-hidden">
        ...
        <Card className="border-border/20 dark:border-white/[0.06] bg-zinc-500/[0.08] shadow-none flex flex-col overflow-hidden">
          <CardContent className="p-4 flex flex-col h-full min-h-0">
            {isLoadingActivities ? (
              ...
              <>
                ...
                <Button
                  className="w-full mt-4 flex-shrink-0 gap-2 font-medium bg-gradient-to-r from-purple-700 to-purple-900 text-white hover:opacity-95 border-0"
