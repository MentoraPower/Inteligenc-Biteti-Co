    ...
    if (panelId === 'crm') {
      ...
      void (async () => {
        ...
        if (subOrigins && subOrigins.length > 0) {
          ...
          navigate(`/crm?origin=${slug}&view=quadro`, { replace: true });
        }
      })();
  ...
  return (
    <div className="min-h-screen bg-card px-3 pb-3">
      <div className="min-h-[calc(100vh-0.75rem)] relative">
        ...
        {/* Mobile Header */}
        <header className="lg:hidden fixed top-[60px] left-0 right-0 h-14 bg-card border-b border-border z-50 flex items-center justify-between px-4">
          <button
        ...
        >
          ...
          >
            <div className="h-full bg-card bg-clip-padding rounded-none overflow-hidden">
              <div
                className={cn(
                  "h-full",
                  animationsEnabled && "transition-opacity duration-400"
              ...
              <div className="flex flex-col gap-1">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    isCRMActive
                      ? "bg-white/10 text-white before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:h-[70%] before:w-1.5 before:rounded-r-full before:bg-gradient-to-b before:from-purple-700 before:to-purple-800"
        ...
        {isDesktop ? (
          ...
          <main className="pt-[calc(60px+56px)] min-h-screen p-4">
            <PageTransition>
              {children}
            </PageTransition>
          </main>
