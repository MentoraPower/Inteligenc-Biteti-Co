...
export const VirtualizedKanbanColumn = memo(function VirtualizedKanbanColumn({ 
  ...
  return (
    <div
      ref={setDroppableRef}
      className="flex-shrink-0 w-[380px] flex flex-col min-h-0 relative"
    >
      <div
      ...
      >
        ...
        <div 
          ...
          className="flex-1 overflow-y-auto px-4 py-3 kanban-scroll bg-[#FAFBFF] dark:bg-zinc-500/[0.03]"
